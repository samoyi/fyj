...
let sOpenID = sHash.slice(sHash.indexOf('openid') + 7);
    ...
    methods: {
        ...
        sendTel(){
            if (!/^1\d{10}$/.test(this.tel)){
                ...
                let data = 'act=phone&phone=' + this.tel + '&vCode=' + this.code + '&openid=' + sOpenID;
                let fnSucceccCallback = (status)=>{
